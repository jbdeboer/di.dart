...
abstract class _Provider {
  ...
  _Provider(this.visibility, this.type);
...
class _ValueProvider extends _Provider {
  ...
  _ValueProvider(type, this.value, [Visibility visibility]) : super(visibility, type);
...
class _TypeProvider extends _Provider {
  ...
  _TypeProvider(type, [Visibility visibility]) : super(visibility, type);
...
class _FactoryProvider extends _Provider {
  ...
  _FactoryProvider(type, this.factoryFn, [Visibility visibility]) : super(visibility, type);
